...
interface DepartmentDetailClientProps {
  /** Server-rendered department payload; null means the server load failed/not-found and the client should fetch. */
  initialData: DeptResponse | null;
}

export function DepartmentDetailClient({ initialData }: DepartmentDetailClientProps) {
  ...
  const [data, setData] = useState<DeptResponse | null>(initialData);
