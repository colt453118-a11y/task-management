...
interface TeamDetailClientProps {
  /** Server-rendered team payload; null means the server load failed/not-found and the client should fetch. */
...
export function TeamDetailClient({ initialData }: TeamDetailClientProps) {
  ...
  const [data, setData] = useState<TeamResponse | null>(initialData);
