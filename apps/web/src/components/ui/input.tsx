  ...
  ({ className, type, error, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          'flex h-10 w-full rounded-xl border bg-surface-100/80 px-3.5 py-2 text-sm shadow-sm transition-all duration-200',
          'file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-surface-700 dark:file:text-surface-300',
          ...
          'disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-surface-200/50 dark:disabled:bg-surface-800/50',
          error
